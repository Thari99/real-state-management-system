    ...
    <div>
      <section className='awards padding'>
        <div className='container'>
          <Heading title='Over 10,000+ Happy Users Being With Us Still They Love Our Services'  />
          ...
          <div className='content grid4 mtop' >
            <div className='box'style={backgroundStyle}>
              ...
              <h1 className='awordnumber'>32 M</h1>
            ...
            <div className='box'style={backgroundStyle}>
              ...
              <h1 className='awordnumber'>43 M</h1>
              <p>Mimo X11 Award</p>
            </div>
            ...
            <div className='box'style={backgroundStyle}>
              ...
              <h1 className='awordnumber'>51 M</h1>
